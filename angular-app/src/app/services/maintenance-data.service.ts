...
import { ApiResponse, MaintenanceData, MaintenanceStats, SearchParams } from '../models/models';
...
export class MaintenanceDataService {
  ...
  getMaintenance(params: SearchParams = {}): Observable<ApiResponse<MaintenanceData>> {
    ...
    return this.http.get<ApiResponse<MaintenanceData>>(this.apiUrl, { params: httpParams });
  }
